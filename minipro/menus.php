	...
	<div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
			<ul class="nav navbar-nav menus">		
				<li class="nav-item"><a class="nav-link" href="index1.php" id="index_menu">Home</a></li>
				<li class="nav-item"><a class="nav-link" href="customer.php" id="customer_menu">User</a></li>
				...
				<li class="nav-item"><a class="nav-link" href="balance1.php" id="order_menu">Amount</a></li>			
			</ul>
		</div>

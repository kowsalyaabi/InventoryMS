                            ...
                            <table  class="table table-bordered table-striped">
								...
								if(mysqli_num_rows($res)){
									foreach($res as $row){
										...
										<td>$row[quantity]</td>
										<td>$row[price]</td>
                                        <td><button class='btn btn-danger'><a class='text-light' href = 'delete1.php?deleteid=".$row['order_id']." '>Delete</a></button></td>
										</tr>
										";
						}
					}
                        ...
                        <div class="modal-body">
                            <form method="post" action="order_update.php">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="order_id" class="form-control rounded-0" required />
                                </div>
                                <div class="mb-3">
                                    <label>User</label>
                                   
                                        <input type="text" name="user"  class="form-control rounded-0" required />        
                        
                                </div> 
                                <div class="mb-3">
                                    <label>Product</label>
                                    <input type="text" name="product" class="form-control rounded-0" />
                                </div>	
                                <div class="mb-3">
                            ...
                            <input type="submit" class="btn btn-primary rounded-0" value="Add" />
